...
best_stream = video_info.getbest(preftype='mp4')

# Open video capture
cap = cv2.VideoCapture(best_stream.url)

# Define pixel-to-meter conversion factors
ym_per_pix = 30 / 720
xm_per_pix = 3.7 / 720
...
out_video = cv2.VideoWriter('C:\\Users\\bit\\Desktop\\opencv_youtube.mp4', fourcc, 20.0, frame_size)
